...
const Hero = () => {
  const stats = [
    ...
    { icon: Trophy, label: 'Live Projects', value: '150+' },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in-left">
            ...
            <p className="text-xl text-foreground/70 mt-6 leading-relaxed">
              Join Codefiks, the  online software training institute. 
              Learn MERN, MEAN, Python Django, Flutter and more. Get hands-on experience 
              with live projects and secure your dream job with our placement support.
            </p>
            
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <button className="bg-primary text-primary-foreground px-8 py-4 rounded-lg font-semibold hover:bg-primary/90 transition-all duration-300 flex items-center justify-center animate-pulse-glow hover-lift group">
                Start Your Journey
                <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" />
              </button>
              <button className="border-2 border-primary text-primary px-8 py-4 rounded-lg font-semibold hover:bg-primary/10 transition-all duration-300 hover-lift">
                Watch Demo
              </button>
            </div>
