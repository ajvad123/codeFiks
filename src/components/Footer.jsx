                  ...
                  return (
                    ...
                    >
                      {social.name === 'WhatsApp' ? (
                        <svg className="h-5 w-5 text-primary hover:text-primary-foreground transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        React.createElement(social.icon, { className: "h-5 w-5 text-primary hover:text-primary-foreground transition-colors duration-300" })
                      )}
                    </button>
                  );
                })}
